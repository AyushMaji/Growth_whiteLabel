...
class _HobbiesFunState extends State<HobbiesFun> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("Why don't we start by setting a goal for your Hobbies or Recreation or Fun. Before we do that, let's first understand how happy you are with the different aspects of your Hobbies or Recreation or Fun ....... On a scale of 1-10 rate the following ...... Hobbies or Recreation or Fun ..... Are you happy that you have enough fun in life ?");
  }
