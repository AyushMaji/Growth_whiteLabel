...
class RoutineHobby extends StatefulWidget {
  static const String id = "/routineHobby";
  const RoutineHobby({Key? key}) : super(key: key);

  @override
  State<RoutineHobby> createState() => _RoutineHobbyState();
}

class _RoutineHobbyState extends State<RoutineHobby> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your daily routine supports joy and fun and relaxation.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that your daily routine supports joy and fun and relaxation.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, HobbiesDifferentAreas.id);
