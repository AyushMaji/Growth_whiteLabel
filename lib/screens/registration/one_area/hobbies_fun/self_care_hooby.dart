...
class SelfCareHobby extends StatefulWidget {
  static const String id = "/selfCareHobby";
  const SelfCareHobby({Key? key}) : super(key: key);

  @override
  State<SelfCareHobby> createState() => _SelfCareHobbyState();
}

class _SelfCareHobbyState extends State<SelfCareHobby> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you know to rest, recharge and recalibrate on a daily basis.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you know to rest, recharge and recalibrate on a daily basis.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, GrowthHobby.id);
