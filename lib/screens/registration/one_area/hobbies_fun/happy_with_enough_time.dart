...
class _HappyWithEnoughTimeState extends State<HappyWithEnoughTime> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" How satisfied are you that you make time to enjoy activities that bring you fun and joy.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you make time to enjoy activities that bring you fun and joy.",
