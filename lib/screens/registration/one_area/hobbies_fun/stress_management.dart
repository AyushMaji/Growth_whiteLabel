...
class StressManagement extends StatefulWidget {
  static const String id = "/stressManagement";
...
class _StressManagementState extends State<StressManagement> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you engage with activities to manage your stress well.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you engage with activities to manage your stress well.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, Adventure.id);
