...
class SkillsHobby extends StatefulWidget {
  static const String id = "/skillsHobby";
  const SkillsHobby({Key? key}) : super(key: key);

  @override
  State<SkillsHobby> createState() => _SkillsHobbyState();
}

class _SkillsHobbyState extends State<SkillsHobby> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you expand your skills in your areas of interest.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you expand your skills in your areas of interest.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, RoutineHobby.id);
