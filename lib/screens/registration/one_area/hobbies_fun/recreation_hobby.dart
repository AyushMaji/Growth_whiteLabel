...
class RecreationHobby extends StatefulWidget {
  static const String id = "/recreationHobby";
  const RecreationHobby({Key? key}) : super(key: key);

  @override
  State<RecreationHobby> createState() => _RecreationHobbyState();
}

class _RecreationHobbyState extends State<RecreationHobby> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you take regular breaks to relax and energise.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you take regular breaks to relax and energise.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, SelfCareHobby.id);
