...
class HobbiesDifferentAreas extends StatefulWidget {
  static const String id = "/hobbiesdifferentAreas";
  const HobbiesDifferentAreas({Key? key}) : super(key: key);

  @override
  State<HobbiesDifferentAreas> createState() => _HobbiesDifferentAreasState();
}

class _HobbiesDifferentAreasState extends State<HobbiesDifferentAreas> {
