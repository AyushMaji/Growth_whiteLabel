...
class HappayWithIterest extends StatefulWidget {
  static const String id = "/happayWithIterest";
  const HappayWithIterest({Key? key}) : super(key: key);

  @override
  State<HappayWithIterest> createState() => _HappayWithIterestState();
}

class _HappayWithIterestState extends State<HappayWithIterest> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you have the right balance between fun and commitments.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you have the right balance between fun and commitments.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, RecreationHobby.id);
