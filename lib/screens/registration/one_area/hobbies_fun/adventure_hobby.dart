...
class Adventure extends StatefulWidget {
  static const String id = "/adventure";
...
class _AdventureState extends State<Adventure> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you nurture your adventurous spirit with exciting experiences.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you nurture your adventurous spirit with exciting experiences.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, SkillsHobby.id);
