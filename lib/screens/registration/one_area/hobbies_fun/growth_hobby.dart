...
class GrowthHobby extends StatefulWidget {
  static const String id = "/growthHobby";
  const GrowthHobby({Key? key}) : super(key: key);

  @override
  State<GrowthHobby> createState() => _GrowthHobbyState();
}

class _GrowthHobbyState extends State<GrowthHobby> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you engage with activities where you learn and expand your knowledge.");
  }
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Stack(
                children: [
                  Image.asset('assets/images/HobbiesRecreationFun.png',
                    //Images.healthCare,
                    fit: BoxFit.cover,
                  ),
                  Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you engage with activities where you learn and expand your knowledge.",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      // getTranslated('happy_with_interests', context),
                      "Growth",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, StressManagement.id);
