...
class BeliefsForSpiri extends StatefulWidget {
  static const String id = "/beliefsForSpiri";
  const BeliefsForSpiri({Key? key}) : super(key: key);

  @override
  State<BeliefsForSpiri> createState() => _BeliefsForSpiriState();
}

class _BeliefsForSpiriState extends State<BeliefsForSpiri> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you are living your life in alignment with your spiritual /religious beliefs.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you are living your life in alignment with your spiritual /religious beliefs.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, SpiritualDifferentAreas.id);
