...
import 'package:olga/screens/registration/one_area/spirituality/Philanthropy.dart';
...
class SocialRes extends StatefulWidget {
  static const String id = "/socialRes";
  const SocialRes({Key? key}) : super(key: key);

  @override
  State<SocialRes> createState() => _SocialResState();
}

class _SocialResState extends State<SocialRes> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you support ethical organisations and businesses.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you support ethical organisations and businesses.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, Philanthropy.id);
