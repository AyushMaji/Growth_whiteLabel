...
class GrowthForSpiritual extends StatefulWidget {
  static const String id = "/growthForSpiritual";
  const GrowthForSpiritual({Key? key}) : super(key: key);

  @override
  State<GrowthForSpiritual> createState() => _GrowthForSpiritualState();
}

class _GrowthForSpiritualState extends State<GrowthForSpiritual> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you invest in your personal and spiritual growth.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you invest in your personal and spiritual growth.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, ServicetoOthers.id);
