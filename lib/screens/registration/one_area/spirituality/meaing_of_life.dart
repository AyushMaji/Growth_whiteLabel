...
class MeaningOfLife extends StatefulWidget {
  static const String id = "/meaningOfLife";
  const MeaningOfLife({Key? key}) : super(key: key);

  @override
  State<MeaningOfLife> createState() => _MeaningOfLifeState();
}

class _MeaningOfLifeState extends State<MeaningOfLife> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you are living in alignment with your values.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you are living in alignment with your values.",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      // getTranslated('happy_with_meaning_of_life', context),
                      "Values",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, HappyWithSpiritualExpression.id);
