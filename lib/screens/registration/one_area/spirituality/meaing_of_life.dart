...
class _MeaningOfLifeState extends State<MeaningOfLife> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" On a scale of 1-10 rate the following ...... Spirituality ..... Are you happy there is meaning in your life?");
  }
