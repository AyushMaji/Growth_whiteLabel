...
class SpiritualIntelligence extends StatefulWidget {
  static const String id = "/spiritualIntelligence";
  const SpiritualIntelligence({Key? key}) : super(key: key);

  @override
  State<SpiritualIntelligence> createState() => _SpiritualIntelligenceState();
}

class _SpiritualIntelligenceState extends State<SpiritualIntelligence> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you connect with your inner knowing.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you connect with your inner knowing.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, RespectOrRights.id);
