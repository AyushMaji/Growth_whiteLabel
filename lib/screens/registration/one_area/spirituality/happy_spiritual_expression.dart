...
import 'spiritual_different_areas.dart';

class HappyWithSpiritualExpression extends StatefulWidget {
  static const String id = "/HappyWithSpiritualExpression";
  const HappyWithSpiritualExpression({Key? key}) : super(key: key);

  @override
  State<HappyWithSpiritualExpression> createState() => _HappyWithSpiritualExpressionState();
}

class _HappyWithSpiritualExpressionState extends State<HappyWithSpiritualExpression> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you are living intentionally and engaged in your life mission.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you are living intentionally and engaged in your life mission.",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      // getTranslated('happy_with_spiritual_expression', context),
                      "Purpose",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, GrowthForSpiritual.id);
