...
class _HappyWithSpiritualExpressionState extends State<HappyWithSpiritualExpression> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" On a scale of 1-10 rate the following ...... Spirituality ..... Are you happy with your spiritual expression?");
  }
