...
class RespectOrRights extends StatefulWidget {
  static const String id = "/respectOrRights";
  const RespectOrRights({Key? key}) : super(key: key);

  @override
  State<RespectOrRights> createState() => _RespectOrRightsState();
}

class _RespectOrRightsState extends State<RespectOrRights> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you protect the rights of others, minorities and the environment.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you protect the rights of others, minorities and the environment.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, BeliefsForSpiri.id);
