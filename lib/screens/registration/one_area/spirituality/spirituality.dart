...
import 'package:olga/screens/registration/one_area/spirituality/meaing_of_life.dart';
import 'package:provider/provider.dart';
import 'package:syncfusion_flutter_charts/charts.dart';

import '../../../../global/constants/images.dart';
import 'happy_spiritual_expression.dart';

class Spirituality extends StatefulWidget {
  static const String id = "/spirituality";
  const Spirituality({Key? key}) : super(key: key);

  @override
  State<Spirituality> createState() => _SpiritualityState();
}

class _SpiritualityState extends State<Spirituality> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("Living based on the powerful interconnectedness of the mind, body and spirit, creates a sense of peace, wholeness and wellbeing and assists in buffering the pain in life’s difficult circumstances through finding meaning. (Align inner world with outer world) Let’s create a plan on how you will achieve your goal in this area. How satisfied are you that you nurture your spirituality/religious beliefs on a daily basis.");
  }
            ...
            Row(
              ...
              children: [
                Flexible(
                  flex: 4,
                  child: Text(
                    // getTranslated("why_dont_start_spirituality_goal", context),
                    //"Let's understand how happy you are with the different aspects of your Spirituality by rating how satisfied you are on a scale of 1-10",
                    "Living based on the powerful interconnectedness of the mind, body and spirit, creates a sense of peace, wholeness and wellbeing and assists in buffering the pain in life’s difficult circumstances through finding meaning. (Align inner world with outer world) Let’s create a plan on how you will achieve your goal in this area.",
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    "How satisfied are you that you nurture your spirituality/religious beliefs on a daily basis.",
                  ...
                  SizedBox(height: 10.sp),
                  Text(
                    // getTranslated('happy_with_life_aligned', context),
                    "Spiritual Practice",
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              setState(() {
                ...
                print('submiteed');
                goPageWithName(context, MeaningOfLife.id);
              });
            },
