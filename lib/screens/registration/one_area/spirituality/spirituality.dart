...
class _SpiritualityState extends State<Spirituality> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("Why don't we start by setting a goal for your Spirituality. Before we do that, let's first understand how happy you are with the different aspects of your Spirituality ....... On a scale of 1-10 rate the following ...... Spirituality ..... Are you happy your life is aligned with your values?");
  }
