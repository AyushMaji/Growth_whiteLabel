...
import 'package:olga/screens/registration/one_area/deep/goal_deep_care.dart';
import 'package:syncfusion_flutter_charts/charts.dart';
import '../../../../provider/storage_provider.dart';
import 'package:provider/provider.dart';


class SpiritualDifferentAreas extends StatefulWidget {
  static const String id = "/SpiritualdifferentAreas";
  const SpiritualDifferentAreas({Key? key}) : super(key: key);

  @override
  State<SpiritualDifferentAreas> createState() => _SpiritualDifferentAreasState();
}

class _SpiritualDifferentAreasState extends State<SpiritualDifferentAreas> {
                ...
                children: [
                  ...
                  Flexible(
                    child: Align(
                      ...
                      child: Text(
                        getTranslated("deep_look_in_career_goal", context) + "${storageValue.oneSelectedArea}",
