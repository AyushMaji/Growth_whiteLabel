...
class Philanthropy extends StatefulWidget {
  static const String id = "/philanthropy";
  const Philanthropy({Key? key}) : super(key: key);
...
class _PhilanthropyState extends State<Philanthropy> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you contribute to philanthropic causes.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you contribute to philanthropic causes.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, SpiritualIntelligence.id);
