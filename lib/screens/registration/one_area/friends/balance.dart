...
class BalanceScreen extends StatefulWidget {
  static const String id = "/balanceScreen";
...
class _BalanceScreenState extends State<BalanceScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you have the right balance between your work family and social commitments.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you have the right balance between your work family and social commitments.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, CommunicationScreen.id);
