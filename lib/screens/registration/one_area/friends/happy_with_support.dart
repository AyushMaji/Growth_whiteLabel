...
class AskingSupport extends StatefulWidget {
  static const String id = "/askingSupport";
  const AskingSupport({Key? key}) : super(key: key);

  @override
  State<AskingSupport> createState() => _AskingSupportState();
}

class _AskingSupportState extends State<AskingSupport> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your friends have your back and you feel safe when sharing.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that your friends have your back and you feel safe when sharing ?",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      // getTranslated('happy_with_asking_support', context),
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, HappyWithActivityShare.id);
