...
class _FriendsState extends State<Friends> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("Why don't we start by setting a goal for your Friends. Before we do that, let's first understand how happy you are with the different aspects of your Friends ....... On a scale of 1-10 rate the following ...... Friends ..... Are you happy being yourself?");
  }
