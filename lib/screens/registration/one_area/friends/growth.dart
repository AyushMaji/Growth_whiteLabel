...
class GrowthScreenForFriend extends StatefulWidget {
  static const String id = "/growthScreenForFriend";
  const GrowthScreenForFriend({Key? key}) : super(key: key);

  @override
  State<GrowthScreenForFriend> createState() => _GrowthScreenForFriendState();
}

class _GrowthScreenForFriendState extends State<GrowthScreenForFriend> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you are open to new relationships.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you are open to new relationships.",
