...
class RespectScreen extends StatefulWidget {
  static const String id = "/respectScreen";
  const RespectScreen({Key? key}) : super(key: key);
...
class _RespectScreenState extends State<RespectScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you nurture your existing friendships.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you nurture your existing friendships.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, GrowthScreenForFriend.id);
