...
import 'friends_different_areas.dart';
import 'happy_with_activity.dart';

class AssertivenessScreen extends StatefulWidget {
  static const String id = "/assertivenessScreen";
  const AssertivenessScreen({Key? key}) : super(key: key);

  @override
  State<AssertivenessScreen> createState() => _AssertivenessScreenState();
}

class _AssertivenessScreenState extends State<AssertivenessScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you express and address upset constructively.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you express and address upset constructively.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, SupportScreen.id);
