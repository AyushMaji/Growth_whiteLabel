...
class HappyWithActivityShare extends StatefulWidget {
  static const String id = "/happyWithActivityShare";
  const HappyWithActivityShare({Key? key}) : super(key: key);

  @override
  State<HappyWithActivityShare> createState() => _HappyWithActivityShareState();
}

class _HappyWithActivityShareState extends State<HappyWithActivityShare> {
