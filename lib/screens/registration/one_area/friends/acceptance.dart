...
class AcceptanceScreen extends StatefulWidget {
  static const String id = "/acceptanceScreen";
...
class _AcceptanceScreenState extends State<AcceptanceScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your friends accept you as you are and support your self -growth.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that your friends accept you as you are and support your self -growth.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, BalanceScreen.id);
