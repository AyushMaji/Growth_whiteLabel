...
class CommunicationScreen extends StatefulWidget {
  static const String id = "/communicationScreen";
...
class _CommunicationScreenState extends State<CommunicationScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you and your friends communicate deeply and share with ease.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you and your friends communicate deeply and share with ease.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, AssertivenessScreen.id);
