...
class FriendsDifferentAreas extends StatefulWidget {
  static const String id = "/FriendsdifferentAreas";
  const FriendsDifferentAreas({Key? key}) : super(key: key);

  @override
  State<FriendsDifferentAreas> createState() => _FriendsDifferentAreasState();
}

class _FriendsDifferentAreasState extends State<FriendsDifferentAreas> {
