...
class VisionScreen extends StatefulWidget {
  static const String id = "/visionScreen";
...
class _VisionScreenState extends State<VisionScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you have a short medium and long term, career plan.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you have a short medium and long term, career plan.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, SocialResponsibilityScreen.id);
