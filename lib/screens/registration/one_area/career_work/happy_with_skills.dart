...
class HappyWithSkills extends StatefulWidget {
  static const String id = "/happyWithSkills";
  const HappyWithSkills({Key? key}) : super(key: key);

  @override
  State<HappyWithSkills> createState() => _HappyWithSkillsState();
}

class _HappyWithSkillsState extends State<HappyWithSkills> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your career choices harness your natural strengths, interests, and skills.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that your career choices harness your natural strengths, interests, and skills.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, VisionScreen.id);
