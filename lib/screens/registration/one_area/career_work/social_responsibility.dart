...
class SocialResponsibilityScreen extends StatefulWidget {
  static const String id = "/socialResponsibilityScreen";
  const SocialResponsibilityScreen({Key? key}) : super(key: key);

  @override
  State<SocialResponsibilityScreen> createState() => _SocialResponsibilityScreenState();
}

class _SocialResponsibilityScreenState extends State<SocialResponsibilityScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you work in a socially and ethically responsible organisation.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you work in a socially and ethically responsible organisation.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, WorkLifeBalanceScreen.id);
