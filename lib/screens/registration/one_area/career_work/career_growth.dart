...
class CareerGrowthScreen extends StatefulWidget {
  static const String id = "/careerGrowthScreen";
  const CareerGrowthScreen({Key? key}) : super(key: key);

  @override
  State<CareerGrowthScreen> createState() => _CareerGrowthScreenState();
}

class _CareerGrowthScreenState extends State<CareerGrowthScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you have opportunities to put your skills and knowledge into practice.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you have opportunities to put your skills and knowledge into practice.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, SkillsQualificationsScreen.id);
