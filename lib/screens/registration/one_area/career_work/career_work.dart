...
class _CareerWorkState extends State<CareerWork> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("Why don't we start by setting a goal for your Career & Work. Before we do that, let's first understand how happy you are with the different aspects of your Career & Work ....... On a scale of 1-10 rate the following ...... Career & Work ..... Are you happy  with your career choices?");
  }
