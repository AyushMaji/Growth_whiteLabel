...
import 'happy_with_career.dart';

class CareerWork extends StatefulWidget {
  static const String id = "/careerWork";
  const CareerWork({Key? key}) : super(key: key);

  @override
  State<CareerWork> createState() => _CareerWorkState();
}

class _CareerWorkState extends State<CareerWork> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("(Peak Performance)hen career /work is in alignment with your values, and supports the expression of your strengths, it gives you a sense of meaning beyond a paycheck increasing your energy levels and life positivity Let’s create a plan on how you will achieve your goal in this area. How satisfied are you that your career/job is stimulating.");
  }
            ...
            Row(
              ...
              children: [
                Flexible(
                  flex: 4,
                  child: Text(
                    // getTranslated("why_dont_start_career_goal", context),
                    //"Let's understand how happy you are with the different aspects of your Career & Work by rating how satisfied you are on a scale of 1-10",
                    "(Peak Performance)hen career/work is in alignment with your values, and supports the expression of your strengths, it gives you a sense of meaning beyond a paycheck increasing your energy levels and life positivity Let’s create a plan on how you will achieve your goal in this area.",
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    "How satisfied are you that your career/job is stimulating.",
                  ...
                  SizedBox(height: 10.sp),
                  Text(
                    // getTranslated('happy_with_career', context),
                    "Job Satisfaction",
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              setState(() {
                ...
                print('submiteed');
                goPageWithName(context, HappayWithCareer.id);
              });
            },
