...
class CVResumeScreen extends StatefulWidget {
  static const String id = "/cVResumeScreen";
  const CVResumeScreen({Key? key}) : super(key: key);

  @override
  State<CVResumeScreen> createState() => _CVResumeScreenState();
}

class _CVResumeScreenState extends State<CVResumeScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your CV /resume is of the standard you want it to be.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that your CV /resume is of the standard you want it to be.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, CareerGrowthScreen.id);
