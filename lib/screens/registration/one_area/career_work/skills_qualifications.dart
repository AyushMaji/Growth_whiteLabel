...
import 'different_areas.dart';

class SkillsQualificationsScreen extends StatefulWidget {
  static const String id = "/skillsQualificationsScreen";
  const SkillsQualificationsScreen({Key? key}) : super(key: key);

  @override
  State<SkillsQualificationsScreen> createState() => _SkillsQualificationsScreenState();
}

class _SkillsQualificationsScreenState extends State<SkillsQualificationsScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your current qualifications support your career plan.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that your current qualifications support your career plan.",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      // getTranslated('employability_options', context),
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, DifferentAreas.id);
