...
class RemunerationScreen extends StatefulWidget {
  static const String id = "/remunerationScreen";
  const RemunerationScreen({Key? key}) : super(key: key);

  @override
  State<RemunerationScreen> createState() => _RemunerationScreenState();
}

class _RemunerationScreenState extends State<RemunerationScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your salary and incentives are what you would like them to be.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that your salary and incentives are what you would like them to be.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, CVResumeScreen.id);
