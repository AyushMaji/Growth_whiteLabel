...
class WorkLifeBalanceScreen extends StatefulWidget {
  static const String id = "/workLifeBalanceScreen";
  const WorkLifeBalanceScreen({Key? key}) : super(key: key);

  @override
  State<WorkLifeBalanceScreen> createState() => _WorkLifeBalanceScreenState();
}

class _WorkLifeBalanceScreenState extends State<WorkLifeBalanceScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you have work life balance.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you have work life balance.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, RemunerationScreen.id);
