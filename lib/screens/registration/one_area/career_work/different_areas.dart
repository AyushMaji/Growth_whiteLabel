...
class DifferentAreas extends StatefulWidget {
  static const String id = "/differentAreas";
  const DifferentAreas({Key? key}) : super(key: key);

  @override
  State<DifferentAreas> createState() => _DifferentAreasState();
}

class _DifferentAreasState extends State<DifferentAreas> {
