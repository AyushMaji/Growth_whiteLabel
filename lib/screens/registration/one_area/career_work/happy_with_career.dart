...
class _HappayWithCareerState extends State<HappayWithCareer> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" On a scale of 1-10 rate the following ...... Career and Work ..... Are you happy  with your career direction?");
  }
              ...
              Stack(
                children: [
                   Transform(
                    ...
                    child: Image.asset(Images.career_Work,
                      //Images.healthCare,
                      width: 260.w,
                    ),
                  ),
