...
import 'happy_with_skills.dart';

class HappayWithCareer extends StatefulWidget {
  static const String id = "/happayWithCareer";
  const HappayWithCareer({Key? key}) : super(key: key);

  @override
  State<HappayWithCareer> createState() => _HappayWithCareerState();
}

class _HappayWithCareerState extends State<HappayWithCareer> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your career/work aligns with your core values.");
  }
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Stack(
                children: [
                   Image.asset(Images.career_Work,
                     //Images.healthCare,
                    fit: BoxFit.cover,
                   ),
                  Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that your career/work aligns with your core values.",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      // getTranslated('happ_with_career_direction', context),
                      "Purpose",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, HappyWithSkills.id);
