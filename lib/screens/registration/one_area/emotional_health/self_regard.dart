...
class SelfRegard extends StatefulWidget {
  static const String id = "/selfRegard";
  const SelfRegard({Key? key}) : super(key: key);

  @override
  State<SelfRegard> createState() => _SelfRegardState();
}

class _SelfRegardState extends State<SelfRegard> {
  ...
  int selectedIndex = 0;
    ...
    @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you accept yourself warts and all.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you accept yourself warts and all.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {          
              goPageWithName(context, SocialSkills.id);
