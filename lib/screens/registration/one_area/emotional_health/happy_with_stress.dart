...
import 'happy_with_joy.dart';

class HappayWithStress extends StatefulWidget {
  static const String id = "/happayWithStress";
  const HappayWithStress({Key? key}) : super(key: key);

  @override
  State<HappayWithStress> createState() => _HappayWithStressState();
}

class _HappayWithStressState extends State<HappayWithStress> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you hold your reactions in check when there is disagreement.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you hold your reactions in check when there is disagreement.",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      // getTranslated('happy_with_manage_stress', context),
                      "Self-Awareness",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {           
              goPageWithName(context, HappyWithJoy.id);
