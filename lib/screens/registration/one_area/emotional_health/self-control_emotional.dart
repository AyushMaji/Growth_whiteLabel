...
class SelfControl extends StatefulWidget {
  static const String id = "/selfControl";
  const SelfControl({Key? key}) : super(key: key);

  @override
  State<SelfControl> createState() => _SelfControlState();
}

class _SelfControlState extends State<SelfControl> {
  ...
  int selectedIndex = 0;
    ...
    @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you communicate calmly with other(s) with opposing views.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you communicate calmly with other(s) with opposing views.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {          
              goPageWithName(context, SelfManagement.id);
