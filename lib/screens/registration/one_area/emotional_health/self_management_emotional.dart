...
class SelfManagement extends StatefulWidget {
  static const String id = "/selfManagement";
  const SelfManagement({Key? key}) : super(key: key);
...
class _SelfManagementState extends State<SelfManagement> {
  ...
  int selectedIndex = 0;
    ...
    @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you respond to life’s demands with calmness, clarity and optimism.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you respond to life’s demands with calmness, clarity and optimism.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {          
              goPageWithName(context, SelfRegard.id);
