...
class SocialSkills extends StatefulWidget {
  static const String id = "/socialSkills";
...
class _SocialSkillsState extends State<SocialSkills> {
  ...
  int selectedIndex = 0;
    ...
    @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you can communicate with a diverse range of people in various settings.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you can communicate with a diverse range of people in various settings.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {          
              goPageWithName(context, Mood.id);
