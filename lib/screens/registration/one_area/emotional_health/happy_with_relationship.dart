...
import 'happy_with_stress.dart';


class HappyWithRelationship extends StatefulWidget {
  static const String id = "/happyWithRelationship";
  const HappyWithRelationship({Key? key}) : super(key: key);

  @override
  State<HappyWithRelationship> createState() => _HappyWithRelationshipState();
}

class _HappyWithRelationshipState extends State<HappyWithRelationship> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you manage your stress levels effectively.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you manage your stress levels effectively.",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      // getTranslated('happy_with_relationships', context),
                      "Stress Management",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {           
              goPageWithName(context, HappayWithStress.id);
