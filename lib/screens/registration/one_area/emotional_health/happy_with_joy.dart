...
import 'emotional_different_areas.dart';

class HappyWithJoy extends StatefulWidget {
  static const String id = "/happyWithJoy";
  const HappyWithJoy({Key? key}) : super(key: key);

  @override
  State<HappyWithJoy> createState() => _HappyWithJoyState();
}

class _HappyWithJoyState extends State<HappyWithJoy> {
  ...
  int selectedIndex = 0;
    ...
    @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you take action to achieve your daily responsibilities and goals.");
  }
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Stack(
                children: [
                  Image.asset(Images.emotional_Health,
                    //Images.healthCare,
                    fit: BoxFit.cover,
                  ),
                  Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you take action to achieve your daily responsibilities and goals.",
                    ...
                    Text(
                      "Vision",
                      // getTranslated('happy_with_levelof_joy', context),
              ...
              //
              //!Text((storageValue.response2 + 1).toString()),
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {          
              goPageWithName(context, SelfControl.id);
