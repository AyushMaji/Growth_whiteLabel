...
class _HappyWithJoyState extends State<HappyWithJoy> {
  ...
  int selectedIndex = 0;
    ...
    @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" On a scale of 1-10 rate the following ...... Emotional Health ..... Are you happy with the level of joy in your life?");
  }
              ...
              Stack(
                children: [
                  Transform(
                    ...
                    child: Image.asset(Images.emotional_Health,
                      //Images.healthCare,
                      width: 260.w,
                    ),
                  ),
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {          
              goPageWithName(context, DifferentAreasForEmotionalHealth.id);
