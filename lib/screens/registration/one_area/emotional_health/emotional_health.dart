...
class _EmotionalHealthState extends State<EmotionalHealth> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("Your ability to be self-reflective, manage stress constructively, maintain good relationships and navigate your thoughts positively are important skills that assist influencing successful outcomes when leading self. (Emotional Wellbeing) Let’s create a plan on how you will achieve your goal in this area. How satisfied are you that you are living in alignment with your core values.");
  }
              ...
              children: [
                Flexible(
                  ...
                  child: Text(
                   ...
                   // "Let's understand how happy you are with the different aspects of your Emotional Health by rating how satisfied you are on a scale of 1-10",
                   "Your ability to be self-reflective, manage stress constructively, maintain good relationships and navigate your thoughts positively are important skills that assist influencing successful outcomes when leading self. (Emotional Wellbeing) Let’s create a plan on how you will achieve your goal in this area.",
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    "How satisfied are you that you are living in alignment with your core values.",
