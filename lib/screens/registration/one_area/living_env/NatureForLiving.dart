...
import 'happy_with_relaxing.dart';
import 'living_different_areas.dart';

class NatureForLiving extends StatefulWidget {
  static const String id = "/natureForLiving";
  const NatureForLiving({Key? key}) : super(key: key);

  @override
  State<NatureForLiving> createState() => _NatureForLivingState();
}

class _NatureForLivingState extends State<NatureForLiving> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your garden compliments your living environment and gives you joy.");
  }
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Stack(
                children: [
                 Image.asset(Images.living_environment,
                   //Images.healthCare,
                   fit: BoxFit.cover,
                 ),
                  Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                     ...
                     "How satisfied are you that your garden compliments your living environment and gives you joy.",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                     // getTranslated('happay_where_you_live', context),
                     "Nature",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, Accommodation.id);
