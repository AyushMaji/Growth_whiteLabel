...
class _HappayWhereLiveState extends State<HappayWhereLive> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" On a scale of 1-10 rate the following ...... Living Environment ..... Are you happy where you live?");
  }
              ...
              Stack(
                children: [
                 Transform(
                    ...
                    child: Image.asset(Images.living_environment,
                      //Images.healthCare,
                      width: 260.w,
                    ),
                  ),
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, LivingDifferentAreas.id);
