...
class Accommodation extends StatefulWidget {
  static const String id = "/accommodation";
...
class _AccommodationState extends State<Accommodation> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your accommodation is the right size for your needs.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                     ...
                     "How satisfied are you that your accommodation is the right size for your needs.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, Lifestyle.id);
