...
class _LivingEnvState extends State<LivingEnv> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("Why don't we start by setting a goal for your Living Environment. Before we do that, let's first understand how happy you are with the different aspects of your Living Environment ....... On a scale of 1-10 rate the following ...... Living Environment ..... Are you happy your space is organised ?");
  }
