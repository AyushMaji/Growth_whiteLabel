...
import 'package:olga/screens/registration/one_area/living_env/happy_with_relaxing.dart';
import 'package:provider/provider.dart';
import '../../../../global/widgets/custom_widgets.dart';
import '../../../../provider/storage_provider.dart';
import 'happy_where_live.dart';

class LivingEnv extends StatefulWidget {
  static const String id = "/livingEnv";
  const LivingEnv({Key? key}) : super(key: key);

  @override
  State<LivingEnv> createState() => _LivingEnvState();
}
...
class _LivingEnvState extends State<LivingEnv> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("Access to clean air, water, quality food, secure housing, green and relaxing spaces where you live and work impacts your mood, and wellbeing by alleviating the stress of modern living. (Physical and Restorative Health) Let’s create a plan on how you will achieve your goal in this area. How satisfied are you that your house is organised and uncluttered.");
  }
            ...
            Row(
              ...
              children: [
                Flexible(
                  flex: 4,
                  child: Text(
                    // getTranslated("why_dont_start_living_goal", context),
                    //"Let's understand how happy you are with the different aspects of your Living Environment by rating how satisfied you are on a scale of 1-10",
                    "Access to clean air, water, quality food, secure housing, green and relaxing spaces where you live and work impacts your mood, and wellbeing by alleviating the stress of modern living. (Physical and Restorative Health) Let’s create a plan on how you will achieve your goal in this area.",
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    "How satisfied are you that your house is organised and uncluttered.",
                  ...
                  SizedBox(height: 10.sp),
                  Text(
                  //  getTranslated('happy_with_space_organised', context),
                  "Living",
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              setState(() {
                ...
                print('submiteed');
                goPageWithName(context, HappyWithRelaxing.id);
              });
            },
