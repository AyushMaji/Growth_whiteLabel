...
class PersonalSpace extends StatefulWidget {
  static const String id = "/personalSpace";
  const PersonalSpace({Key? key}) : super(key: key);
...
class _PersonalSpaceState extends State<PersonalSpace> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your bedroom nurtures rest, relaxation and good health.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                     ...
                     "How satisfied are you that your bedroom nurtures rest, relaxation and good health.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, Technology.id);
