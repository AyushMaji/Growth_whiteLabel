...
class HappyWithRelaxing extends StatefulWidget {
  static const String id = "/happyWithRelaxing";
  const HappyWithRelaxing({Key? key}) : super(key: key);

  @override
  State<HappyWithRelaxing> createState() => _HappyWithRelaxingState();
}

class _HappyWithRelaxingState extends State<HappyWithRelaxing> {
  ...
  int selectedIndex = 0;
    ...
    @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you live in a location that is to your liking.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you live in a location that is to your liking.",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                     // getTranslated('happy_with_relaxing', context),
                     "Location",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, HappayWhereLive.id);
