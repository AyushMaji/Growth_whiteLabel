...
class Wellbeing extends StatefulWidget {
  static const String id = "/Wellbeing";
...
class _WellbeingState extends State<Wellbeing> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your living environment enhances your wellbeing.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                     ...
                     "How satisfied are you that your living environment enhances your wellbeing.",
