...
class Technology extends StatefulWidget {
  static const String id = "/technology";
...
class _TechnologyState extends State<Technology> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your technical (phone/computer) gadgets are organised and easy to navigate.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                     ...
                     "How satisfied are you that your technical (phone/computer) gadgets are organised and easy to navigate.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, NatureForLiving.id);
