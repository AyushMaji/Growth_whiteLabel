...
class Lifestyle extends StatefulWidget {
  static const String id = "/lifestyle";
...
class _LifestyleState extends State<Lifestyle> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you are living your ideal lifestyle Eg: overseas, by the beach, country, inner city.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                     ...
                     "How satisfied are you that you are living your ideal lifestyle Eg: overseas, by the beach, country, inner city.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, Safety.id);
