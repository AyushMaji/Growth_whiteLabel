...
class LivingDifferentAreas extends StatefulWidget {
  static const String id = "/LivingdifferentAreas";
  const LivingDifferentAreas({Key? key}) : super(key: key);

  @override
  State<LivingDifferentAreas> createState() => _LivingDifferentAreasState();
}

class _LivingDifferentAreasState extends State<LivingDifferentAreas> {
     @override
  void initState() {
    super.initState();
     //###############################################################
