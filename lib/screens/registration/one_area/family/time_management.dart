...
class TimeManagementScreen extends StatefulWidget {
  static const String id = "/timeManagementScreen";
...
class _TimeManagementScreenState extends State<TimeManagementScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you spend quality time with your family.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you spend quality time with your family.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, ExtendedFamilyScreen.id);
