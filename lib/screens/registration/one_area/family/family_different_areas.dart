...
class FamilyDifferentAreas extends StatefulWidget {
  static const String id = "/FamilyDifferentAreasfamily";
  const FamilyDifferentAreas({Key? key}) : super(key: key);

  @override
  State<FamilyDifferentAreas> createState() => _FamilyDifferentAreasState();
}

class _FamilyDifferentAreasState extends State<FamilyDifferentAreas> {
