...
class RespectScreenForFamily extends StatefulWidget {
  static const String id = "/respectScreenForFamily";
  const RespectScreenForFamily({Key? key}) : super(key: key);

  @override
  State<RespectScreenForFamily> createState() => _RespectScreenForFamilyState();
}

class _RespectScreenForFamilyState extends State<RespectScreenForFamily> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your family respects each other despite differences of opinions.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that your family respects each other despite differences of opinions.",
                            ...
                            return InkWell(
                              onTap: () {
                                ...
                                setState(() {
                                  ...
                                  // absoreTap = true;
                                   setColorsinIndex(index, context);
                                  storageValue.updateResponse7(index);
                                  selectedIndex = (index+1);
                                  showButton = true;
                                  absoreTap = true;  
                                });
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, BoundariesScreenForFamily.id);
