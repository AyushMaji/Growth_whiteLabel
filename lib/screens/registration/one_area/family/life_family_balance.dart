...
class FamilyBalanceScreenForFamily extends StatefulWidget {
  static const String id = "/familyBalanceScreenForFamily";
  const FamilyBalanceScreenForFamily({Key? key}) : super(key: key);

  @override
  State<FamilyBalanceScreenForFamily> createState() => _FamilyBalanceScreenForFamilyState();
}

class _FamilyBalanceScreenForFamilyState extends State<FamilyBalanceScreenForFamily> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you balance personal needs with family needs.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you balance personal needs with family needs.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, FamilyDifferentAreas.id);
