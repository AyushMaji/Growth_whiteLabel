...
class _HappyWithCommunicateState extends State<HappyWithCommunicate> {
  ...
  int selectedIndex = 0;
     ...
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" On a scale of 1-10 rate the following ...... Family ..... Are you happy with how you communicate wth your family?");
  }
