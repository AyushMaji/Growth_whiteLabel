...
import 'happy_with_spending.dart';

class HappyWithCommunicate extends StatefulWidget {
  static const String id = "/happyWithCommunicate";
  const HappyWithCommunicate({Key? key}) : super(key: key);

  @override
  State<HappyWithCommunicate> createState() => _HappyWithCommunicateState();
}

class _HappyWithCommunicateState extends State<HappyWithCommunicate> {
  ...
  int selectedIndex = 0;
     ...
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your family understand you on a deeper level.");
  }
  ...
  Widget build(BuildContext context) {
    ...
    //###############################################################
    HappyLifeSurvey happyLifeSurvey =  Provider.of<HappyLifeSurvey>(context, listen: false);
    //
    return Scaffold(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that your family understand you on a deeper level.",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      // getTranslated('happy_with_communicate_with_family', context),
                      "Support",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, HappyWithSpending.id);
