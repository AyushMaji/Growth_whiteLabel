...
class ExtendedFamilyScreen extends StatefulWidget {
  static const String id = "/extendedFamilyScreen";
  const ExtendedFamilyScreen({Key? key}) : super(key: key);

  @override
  State<ExtendedFamilyScreen> createState() => _ExtendedFamilyScreenState();
}

class _ExtendedFamilyScreenState extends State<ExtendedFamilyScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you have positive connections with your extended family.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you have positive connections with your extended family.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, AcceptanceScreenForFamily.id);
