...
class AcceptanceScreenForFamily extends StatefulWidget {
  static const String id = "/acceptanceScreenForFamily";
  const AcceptanceScreenForFamily({Key? key}) : super(key: key);

  @override
  State<AcceptanceScreenForFamily> createState() => _AcceptanceScreenForFamilyState();
}

class _AcceptanceScreenForFamilyState extends State<AcceptanceScreenForFamily> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you family accepts you for who you are.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you family accepts you for who you are.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, RespectScreenForFamily.id);
