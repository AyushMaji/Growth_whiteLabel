...
class HappyWithSpending extends StatefulWidget {
  static const String id = "/happyWithSpending";
  const HappyWithSpending({Key? key}) : super(key: key);

  @override
  State<HappyWithSpending> createState() => _HappyWithSpendingState();
}

class _HappyWithSpendingState extends State<HappyWithSpending> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your connection with your family is strong.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that your connection with your family is strong.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, TimeManagementScreen.id);
