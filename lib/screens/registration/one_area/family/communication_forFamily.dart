...
import 'family_different_areas.dart';

class CommunicationScreenForFamily extends StatefulWidget {
  static const String id = "/communicationScreenForFamily";
  const CommunicationScreenForFamily({Key? key}) : super(key: key);

  @override
  State<CommunicationScreenForFamily> createState() => _CommunicationScreenForFamilyState();
}

class _CommunicationScreenForFamilyState extends State<CommunicationScreenForFamily> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you can communicate effectively with your family.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you can communicate effectively with your family.",
                    ...
                    Text(
                      "Communication",
                      // getTranslated('happy_with_spending_time', context),
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, FamilyBalanceScreenForFamily.id);
