...
class _RomanceIntimacyGoalState extends State<RomanceIntimacyGoal> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("Why don't we start by setting a goal for your Romance & Intimacy. Before we do that, let's first understand how happy you are with the different aspects of your Romance & Intimacy.......On a scale of 1-10 rate the following...... Romance & Intimacy.....Are you happy that you communicate effectively?");
  }
