...
class IntimacyScreen extends StatefulWidget {
  static const String id = "/intimacyScreen";
  const IntimacyScreen({Key? key}) : super(key: key);

  @override
  State<IntimacyScreen> createState() => _IntimacyScreenState();
}

class _IntimacyScreenState extends State<IntimacyScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you have a healthy romantic life.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you have a healthy romantic life.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, ConflictManagementScreen.id);
