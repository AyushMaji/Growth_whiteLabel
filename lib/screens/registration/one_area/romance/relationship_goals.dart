...
class RelationshipGoalsScreen extends StatefulWidget {
  static const String id = "/relationshipGoalsScreen";
...
class _RelationshipGoalsScreenState extends State<RelationshipGoalsScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you can set independent and joint goals in your relationship.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you can set independent and joint goals in your relationship.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, LifeBalanceScreen.id);
