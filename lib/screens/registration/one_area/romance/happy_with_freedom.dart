...
class _HappyWithFreedomState extends State<HappyWithFreedom> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" On a scale of 1-10 rate the following ...... Romance & Intimacy ..... Are you happy with the level of freedom in the relationship?");
  }
