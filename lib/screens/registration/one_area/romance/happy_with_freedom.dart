...
import 'happy_with_sex_life.dart';

class HappyWithFreedom extends StatefulWidget {
  static const String id = "/happyWithFreedom";
  const HappyWithFreedom({Key? key}) : super(key: key);

  @override
  State<HappyWithFreedom> createState() => _HappyWithFreedomState();
}

class _HappyWithFreedomState extends State<HappyWithFreedom> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you have romance and intimacy in your life?");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you have romance and intimacy in your life?",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      // getTranslated('happy_with_lavel_of_freedom', context),
                      "Romance",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, HappyWIthSexLife.id);
