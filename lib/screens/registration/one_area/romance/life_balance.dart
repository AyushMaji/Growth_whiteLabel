...
class LifeBalanceScreen extends StatefulWidget {
  static const String id = "/lifeBalanceScreen";
...
class _LifeBalanceScreenState extends State<LifeBalanceScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you balance well your personal freedom with commitment ? ");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you balance well your personal freedom with commitment.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, IntimacyScreen.id);
