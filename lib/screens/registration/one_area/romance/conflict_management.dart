...
import 'different_areas_r.dart';



class ConflictManagementScreen extends StatefulWidget {
  static const String id = "/conflictManagementScreen";
  const ConflictManagementScreen({Key? key}) : super(key: key);

  @override
  State<ConflictManagementScreen> createState() => _ConflictManagementScreenState();
}

class _ConflictManagementScreenState extends State<ConflictManagementScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you address differences respectfully.");
  }
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Stack(
                children: [
                  Image.asset(Images.romance_Intimacy,
                    //Images.healthCare,
                    fit: BoxFit.cover,
                  ),
                  Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you address differences respectfully.",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      // getTranslated('happy_with_your_sex_life', context),
                      "Conflict Management",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, DifferentAreasForRomance.id);
