...
class PersonalRights extends StatefulWidget {
  static const String id = "/personalRights";
  const PersonalRights({Key? key}) : super(key: key);

  @override
  State<PersonalRights> createState() => _PersonalRightsState();
}

class _PersonalRightsState extends State<PersonalRights> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you are safe and free to be yourself in relationships.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you are safe and free to be yourself in relationships.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, BoundariesScreen.id);
