...
class GrowthScreen extends StatefulWidget {
  static const String id = "/growthScreen";
...
class _GrowthScreenState extends State<GrowthScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you have space to grow with your partner but also independently as people? ");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you have space to grow with your partner but also independently as people.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, RelationshipGoalsScreen.id);
