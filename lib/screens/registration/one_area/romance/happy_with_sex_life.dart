...
class _HappyWIthSexLifeState extends State<HappyWIthSexLife> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" On a scale of 1-10 rate the following ...... Romance & Intimacy ..... Are you happy with your sex life?");
  }
              ...
              Stack(
                children: [
                  Transform(
                    ...
                    child: Image.asset(Images.romance_Intimacy,
                      //Images.healthCare,
                      width: 260.w,
                    ),
                  ),
