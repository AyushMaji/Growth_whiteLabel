...
class HappyWIthSexLife extends StatefulWidget {
  static const String id = "/happyWIthSexLife";
  const HappyWIthSexLife({Key? key}) : super(key: key);

  @override
  State<HappyWIthSexLife> createState() => _HappyWIthSexLifeState();
}

class _HappyWIthSexLifeState extends State<HappyWIthSexLife> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you communicate respectfully effectively and clearly with your partner.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you communicate respectfully effectively and clearly with your partner.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, PersonalRights.id);
