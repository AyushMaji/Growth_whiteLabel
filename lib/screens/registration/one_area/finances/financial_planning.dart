...
class FinancialPlanningScreen extends StatefulWidget {
  static const String id = "/financialPlanningScreen";
  const FinancialPlanningScreen({Key? key}) : super(key: key);
...
class _FinancialPlanningScreenState extends State<FinancialPlanningScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you have a financial plan that supports your current and future goals.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                     ...
                     "How satisfied are you that you have a financial plan that supports your current and future goals.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            title: getTranslated('submit', context),
              onPressed: () {            
                goPageWithName(context, RetirementScreen.id);
