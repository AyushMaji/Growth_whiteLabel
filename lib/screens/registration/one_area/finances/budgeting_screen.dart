...
class BudgetingScreen extends StatefulWidget {
  static const String id = "/budgetingScreen";
...
class _BudgetingScreenState extends State<BudgetingScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you are living within your means and can meet your financial obligations.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                     ...
                     "How satisfied are you that you are living within your means and can meet your financial obligations.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            title: getTranslated('submit', context),
              onPressed: () {            
                goPageWithName(context, FinancialPlanningScreen.id);
