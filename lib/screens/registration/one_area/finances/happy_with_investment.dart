...
class HappayWithInvestment extends StatefulWidget {
  static const String id = "/happayWithInvestment";
  const HappayWithInvestment({Key? key}) : super(key: key);

  @override
  State<HappayWithInvestment> createState() => _HappayWithInvestmentState();
}

class _HappayWithInvestmentState extends State<HappayWithInvestment> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you have adequate savings towards buying a home or things of importance to you.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                     ...
                     "How satisfied are you that you have adequate savings towards buying a home or things of importance to you.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            title: getTranslated('submit', context),
              onPressed: () {            
                goPageWithName(context, DebtScreen.id);
