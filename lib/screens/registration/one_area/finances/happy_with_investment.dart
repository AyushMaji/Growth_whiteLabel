...
class _HappayWithInvestmentState extends State<HappayWithInvestment> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" On a scale of 1-10 rate the following ...... Finance ..... Are you happy with your investments?");
  }
              ...
              Stack(
                children: [
                   Transform(
                    ...
                    child: Image.asset(Images.finances,
                      //Images.healthCare,
                      width: 260.w,
                    ),
                  ),
        ...
        child: Padding(
          ...
          child: SubmitButton(
            title: getTranslated('submit', context),
              onPressed: () {            
                goPageWithName(context, FinanceDifferentAreas.id);
