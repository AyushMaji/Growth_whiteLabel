...
class _FinancesState extends State<Finances> {
  ...
  void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("Why don't we start by setting a goal for your Finances. Before we do that, let's first understand how happy you are with the different aspects of your Finances ....... On a scale of 1-10 rate the following ...... Finances ..... Are you happy with the income you earn?");
  }
            ...
            Align(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10.sp),
                  Text(
                    getTranslated('happy_with_income', context),
