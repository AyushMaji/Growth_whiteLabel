...
class HappyWithSavings extends StatefulWidget {
  static const String id = "/happyWithSavings";
  const HappyWithSavings({Key? key}) : super(key: key);

  @override
  State<HappyWithSavings> createState() => _HappyWithSavingsState();
}

class _HappyWithSavingsState extends State<HappyWithSavings> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that your investment portfolio is strong and growing.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that your investment portfolio is strong and growing.",
                    ...
                    Text(
                      "Investments",
                      // getTranslated('happy_with_saving_lavel', context),
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
                ...
                goPageWithName(context, HappayWithInvestment.id);
