...
class FinanceDifferentAreas extends StatefulWidget {
  static const String id = "/financedifferentAreas";
  const FinanceDifferentAreas({Key? key}) : super(key: key);

  @override
  State<FinanceDifferentAreas> createState() => _FinanceDifferentAreasState();
}

class _FinanceDifferentAreasState extends State<FinanceDifferentAreas> {
     @override
  void initState() {
    super.initState();
     //###############################################################
