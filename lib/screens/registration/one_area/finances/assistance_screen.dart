...
class AssistanceScreen extends StatefulWidget {
  static const String id = "/assistanceScreen";
...
class _AssistanceScreenState extends State<AssistanceScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you financial position allows you to help others.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                     ...
                     "How satisfied are you that you financial position allows you to help others.",
