...
class DebtScreen extends StatefulWidget {
  static const String id = "/debtScreen";
...
class _DebtScreenState extends State<DebtScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you are making your loan repayments.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                     ...
                     "How satisfied are you that you are making your loan repayments.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            title: getTranslated('submit', context),
              onPressed: () {            
                goPageWithName(context, FinancialHealthScreen.id);
