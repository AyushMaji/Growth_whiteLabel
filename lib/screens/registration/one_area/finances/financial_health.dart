...
class FinancialHealthScreen extends StatefulWidget {
  static const String id = "/financialHealthScreen";
...
class _FinancialHealthScreenState extends State<FinancialHealthScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you are on top of your different financial responsibilities.");
  }
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                     ...
                     "How satisfied are you that you are on top of your different financial responsibilities.",
        ...
        child: Padding(
          ...
          child: SubmitButton(
            title: getTranslated('submit', context),
              onPressed: () {            
                goPageWithName(context, BudgetingScreen.id);
