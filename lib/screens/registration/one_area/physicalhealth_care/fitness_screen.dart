...
class FitnessScreen extends StatefulWidget {
  static const String id = "Fitness";
...
class _FitnessScreenState extends State<FitnessScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" On a scale of 1-10 rate the following ...... Physical Health & Self-care ..... Are you happy with your diet and nutrition?");
  }
          ...
          child: Column(
            children: [
              ...
              Stack(
                children: [
                  Transform(
                        transform: Matrix4.rotationZ(-0.999000), 
              ...
              Align(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      getTranslated('are_you_nutrition', context),
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
            //storageValue.updateFitnessScaleValue(selectedIndex);
            goPageWithName(context, HealthScreen.id);
