...
class _FitnessScreenState extends State<FitnessScreen> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you protect your health from unhealthy food and substances.");
  }
             ...
             // SizedBox(height: 10.sp),
              ...
              Align(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      getTranslated("How_satisfied_you", context),
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      getTranslated('Impulse_Control', context),
