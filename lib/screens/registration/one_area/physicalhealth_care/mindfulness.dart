...
class MindfulnessWheel extends StatefulWidget {
  static const String id = "/mindfulnessWheel";
  const MindfulnessWheel({Key? key}) : super(key: key);

  @override
  State<MindfulnessWheel> createState() => _MindfulnessWheelState();
}

class _MindfulnessWheelState extends State<MindfulnessWheel> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" How satisfied are you that you can calm and relax your mind to make good life decisions.");
  }
  @override
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you can calm and relax your mind to make good life decisions.",
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return InkWell(
                              onTap: () {
                                ...
                                setState(() {
                                  setColorsinIndex(index, context);
                                   storageValue.updateResponse10(index);
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, HealthCareReport.id);
