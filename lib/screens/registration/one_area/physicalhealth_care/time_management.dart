...
class TimeManagementWheel extends StatefulWidget {
  static const String id = "/timeManagementWheel";
  const TimeManagementWheel({Key? key}) : super(key: key);

  @override
  State<TimeManagementWheel> createState() => _TimeManagementWheelState();
}

class _TimeManagementWheelState extends State<TimeManagementWheel> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you make time to nurture your physical and emotional wellbeing.");
  }
  @override
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you make time to nurture your physical and emotional wellbeing.",
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return InkWell(
                              onTap: () {
                                ...
                                setState(() {
                                  setColorsinIndex(index, context);
                                   storageValue.updateResponse9(index);
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, MindfulnessWheel.id);
