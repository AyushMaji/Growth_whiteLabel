...
class EmotionalWheel extends StatefulWidget {
  static const String id = "/emotionalWheel";
...
class _EmotionalWheelState extends State<EmotionalWheel> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" How satisfied are you that you have a healthy relationship with food and alcohol.");
  }
  @override
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you have a healthy relationship with food and alcohol.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, TimeManagementWheel.id);
