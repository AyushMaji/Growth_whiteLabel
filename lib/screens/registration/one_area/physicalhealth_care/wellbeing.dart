...
import 'package:olga/screens/registration/one_area/physicalhealth_care/weight_wheel_screen.dart';
...
import 'health_care_report.dart';

class WellBeingWheel extends StatefulWidget {
  static const String id = "/wellBeingWheel";
  const WellBeingWheel({Key? key}) : super(key: key);

  @override
  State<WellBeingWheel> createState() => _WellBeingWheelState();
}

class _WellBeingWheelState extends State<WellBeingWheel> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you engage in activities that nurture you mind body and spirit.");
  }
  @override
  ...
  //###############################################################
    ...
    //-------------
    HappyLifeSurvey happyLifeSurvey = Provider.of(context, listen: false);
  //###############################################################
    return Scaffold(
          ...
          child: Column(
            children: [
              ...
              Stack(
                children: [
                   Image.asset(
                     Images.physical_health_selfcare,
                     //Images.healthCare,
                   fit: BoxFit.contain,
                   ),
                  Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you engage in activities that nurture you mind body and spirit.",
                      style: TextStyles.smallBoldTextStyle(context),
                    ),
                    
                    SizedBox(height: 10.sp),
                    Text(
                      // getTranslated('level_of_self_care', context),
                      "Wellbeing",
              ...
              AbsorbPointer(
                ...
                child: Padding(
                  ...
                  //             storageValue.updateResponse4(index);
                  //             selectedIndex = index;
                  //             absoreTap = true;
                  //             showButton = true;
                  //           });
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return InkWell(
                              onTap: () {
                                ...
                                setState(() {
                                  setColorsinIndex(index, context);
                                   storageValue.updateResponse6(index);
              ...
              Row(
                ...
                children: [
                  ...
                  Text(getTranslated("satisfied", context)),
                ],
              ),
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, WeightWheel.id);
