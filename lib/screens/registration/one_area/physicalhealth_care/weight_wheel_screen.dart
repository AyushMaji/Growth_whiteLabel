...
class WeightWheel extends StatefulWidget {
  static const String id = "/weightWheel";
  const WeightWheel({Key? key}) : super(key: key);
...
class _WeightWheelState extends State<WeightWheel> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you are at your ideal weight for good health.");
  }
  @override
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you are at your ideal weight for good health.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, EmotionalWheel.id);
