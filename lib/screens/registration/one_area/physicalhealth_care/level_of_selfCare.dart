...
class LevelSelfCare extends StatefulWidget {
  static const String id = "/levelSelfCare";
  const LevelSelfCare({Key? key}) : super(key: key);

  @override
  State<LevelSelfCare> createState() => _LevelSelfCareState();
}

class _LevelSelfCareState extends State<LevelSelfCare> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you keep well hydrated and have a clean diet that fuels your body.");
  }
  @override
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you keep well hydrated and have a clean diet that fuels your body.",
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, SleepWheel.id);
