...
import 'package:olga/screens/registration/one_area/physicalhealth_care/wellbeing.dart';
...
class SleepWheel extends StatefulWidget {
  static const String id = "/sleepWheel";
  const SleepWheel({Key? key}) : super(key: key);

  @override
  State<SleepWheel> createState() => _SleepWheelState();
}

class _SleepWheelState extends State<SleepWheel> {
  ...
  @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you wake up ready to start each day, rested and energised.");
  }
  @override
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      "How satisfied are you that you wake up ready to start each day, rested and energised.",
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return InkWell(
                              onTap: () {
                                ...
                                setState(() {
                                  setColorsinIndex(index, context);
                                   storageValue.updateResponse5(index);
      ...
      bottomSheet: Visibility(
        ...
        child: Padding(
          ...
          child: SubmitButton(
            ...
            onPressed: () {
              goPageWithName(context, WellBeingWheel.id);
