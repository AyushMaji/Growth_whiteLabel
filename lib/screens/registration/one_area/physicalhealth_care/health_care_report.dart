...
class HealthCareReport extends StatefulWidget {
  static const String id = "HealthCareReport";
  const HealthCareReport({Key? key}) : super(key: key);

  @override
  State<HealthCareReport> createState() => _HealthCareReportState();
}

class _HealthCareReportState extends State<HealthCareReport> {
                ...
                children: [
                  ...
                  Flexible(
                    child: Align(
                      ...
                      child: Text(
                        getTranslated('well_done_looking_deep', context),
