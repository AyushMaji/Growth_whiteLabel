...
class _HealthScreenState extends State<HealthScreen> {
  ...
  int selectedIndex = 0;
   ...
   @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak(" On a scale of 1-10 rate the following ...... Physical Health & Self-care ..... Are you happy with the quality of your sleep?");
  }
