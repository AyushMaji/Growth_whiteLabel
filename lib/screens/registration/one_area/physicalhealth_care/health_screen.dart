...
import 'level_of_selfCare.dart';

class HealthScreen extends StatefulWidget {
  static const String id = "/healthAndCare";
...
class _HealthScreenState extends State<HealthScreen> {
  ...
  int selectedIndex = 0;
   ...
   @override
     void initState() {
    super.initState();
    Provider.of<StorageProvider>(context, listen: false).audioSpeak("How satisfied are you that you accept your body with its strengths and flaws.");
  }
              ...
              Align(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    "How satisfied are you that you accept your body with its strengths and flaws.",
                    ...
                    SizedBox(height: 10.sp),
                    Text(
                      // getTranslated('quality_sleep', context),
                      "Body Image",
          ...
          child: SubmitButton(
            ...
            onPressed: () {
             // goPageWithName(context, HealthCareReport.id);
               goPageWithName(context, LevelSelfCare.id);
